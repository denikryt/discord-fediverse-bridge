...
def test_fanout_report_detects_missing_rule_prefixes()->None:
 entries=(SimpleNamespace(rule_id='present',family='routing',classification='typed_case',node_prefixes=('file.py::test_present',)),SimpleNamespace(rule_id='missing',family='retry',classification='named_scenario',node_prefixes=('file.py::test_missing',)))
