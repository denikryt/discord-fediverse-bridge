...
try:
    from tools.contract_report_support import CollectedCaseResult, PassiveCaseCollector, status_totals
except ModuleNotFoundError:
    from contract_report_support import CollectedCaseResult, PassiveCaseCollector, status_totals
        ...
        rows.append(
            {
                ...
                "represented": represented,
                "nodes": [{"nodeid": nodeid, "status": status[nodeid]} for nodeid in nodes],
            }
        )
