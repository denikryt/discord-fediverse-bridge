...
def is_super_admin(*, discord_user_id: str, policy_snapshot: BridgePolicySnapshot) -> bool:
    """Return whether the Discord user is an effective bridge super-admin."""
    return policy_snapshot.is_super_admin(discord_user_id)


def can_manage_local_community(*, discord_user_id: str, local_community: LocalCommunity, policy_snapshot: BridgePolicySnapshot) -> bool:
...
def can_access_local_community_from_guild(*, discord_user_id: str, discord_guild_id: int | None, local_community: LocalCommunity, policy_snapshot: BridgePolicySnapshot, include_disabled: bool = False) -> bool:
