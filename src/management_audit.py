...
VALID_REASON_CODES = frozenset(
    {REASON_NOT_SUPER_ADMIN, REASON_NOT_OWNER_OR_SUPER_ADMIN, REASON_COMMUNITY_DISABLED}
)
VALID_TARGET_TYPES = frozenset({TARGET_LOCAL_COMMUNITY, TARGET_REMOTE_ACTOR})
