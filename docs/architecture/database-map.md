...
| `local_community_followers` | `LocalCommunityFollower` | Local community hosting | Local follow handler | Local fanout | Remote actors following local communities | Unique community/remote actor and Follow id |
...
| `local_community_threads` | `LocalCommunityThread` | Local community hosting | Local runtime | Local reply/edit/delete | Map local-community post state | Unique Discord thread, starter message, AP activity, and AP object |
| `local_community_messages` | `LocalCommunityMessage` | Local community hosting | Local runtime | Local reply/edit/delete | Map local-community message state | Unique Discord message, AP activity, and AP object |
