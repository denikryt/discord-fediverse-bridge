...
1. `src/activitypub_handlers.py`; 2. `src/content_sync/persistence.py`; 3. `src/db/repositories/event_receipts.py`; 4. `src/db/repositories/message_mappings.py`; 5. `src/db/repositories/activitypub_objects.py`; 6. `src/db/database.py` temporary wrappers; 7. `fedify-gateway/src/normalize.ts`.
